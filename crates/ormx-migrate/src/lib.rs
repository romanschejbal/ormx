...
//!
//! This crate compares two [`ormx_core::schema::Schema`] versions (the
//! "applied" state vs. the current `.ormx` file) and produces SQL migration
...
//! - [`state`] -- tracks applied migrations in the `_ormx_migrations` table.
//!
//! # Related crates
//!
